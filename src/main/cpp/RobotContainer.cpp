...
void RobotContainer::ConfigureButtonBindings() {
  ...
  frc2::JoystickButton(&m_driverController, frc::XboxController::Button::kStart).WhenPressed(SetFar);
...
//    frc2::RunCommand([this] {m_clamp.RunClaw(-0.5);}, {&m_clamp})).WhenReleased(frc2::RunCommand([this] {m_clamp.RunClaw(0.0);}, {&m_clamp}));
 ...
 frc2::JoystickButton(&m_driverController, frc::XboxController::Button::kRightBumper).WhenPressed(CloseClaw);
 frc2::JoystickButton(&m_driverController, frc::XboxController::Button::kLeftBumper).WhenPressed(OpenClaw);
 frc2::JoystickButton(&m_driverController, frc::XboxController::Button::kBack).WhenPressed(CloseCube);
 ...
 frc2::JoystickButton(&m_driverController, frc::XboxController::Button::kRightStick).WhenPressed(InFrame);
