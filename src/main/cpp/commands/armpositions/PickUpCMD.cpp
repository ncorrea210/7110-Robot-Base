...
PickUpCMD::PickUpCMD(ExtensionSubsystem* extension, ActuatorSubsystem* actuator, std::function<bool()> cone) : m_extension(extension), m_actuator(actuator), m_cone(std::move(cone)) {
